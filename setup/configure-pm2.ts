...
const HOME = homedir();
const RELAY_USER_DIR = process.env.RELAY_USER_DIR || process.env.RELAY_DIR || join(HOME, ".claude-relay");
const LOGS_DIR = process.env.PM2_LOG_DIR || join(RELAY_USER_DIR, "logs");
