...
// ============================================================
// Module mocks — needed because memory-dedup-review.ts transitively
// imports from memory-cleanup.ts which imports local stack modules.
// These mocks prevent real DB/Qdrant/Ollama connections during tests.
// ============================================================
