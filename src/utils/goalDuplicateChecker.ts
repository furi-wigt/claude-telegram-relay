 ...
 */
/**
 * Generic text duplicate check — works for any memory type (facts, goals, etc.).
 * Alias for isTextDuplicateGoal (same logic, clearer name for non-goal callers).
 */
export const isTextDuplicate = isTextDuplicateGoal;
