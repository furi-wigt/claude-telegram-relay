...
module.exports = {
  apps: [
    ...
    // ── TRO Monthly Update ─────────────────────────────────────────────────
    // 2nd Friday of month at 16:00 SGT (08:00 UTC).
    // Cron trick: day 8-14 + Friday (5) = exactly the 2nd Friday.
    {
      name: "tro-monthly-update",
      script: "routines/tro-monthly-update.ts",
      interpreter: BUN,
      exec_mode: "fork",
      cwd: CWD,
      instances: 1,
      ...
      max_restarts: 3,
      watch: false,
      cron_restart: "0 8 8-14 * 5",
      env: ENV,
      error_file: CWD + "/logs/tro-monthly-update-error.log",
      out_file: CWD + "/logs/tro-monthly-update.log",
      log_date_format: "YYYY-MM-DD HH:mm:ss Z",
    },
